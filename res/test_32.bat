...
rem PATH=C:\Miniconda35;C:\Miniconda35\Scripts;%PATH%
rem pip install tesserocr\dist\tesserocr-2.2.2-cp35-cp35m-win32.whl
rem conda install Pillow --yes
rem python tesserocr\tests\test_api.py
...
PATH=C:\Miniconda37;C:\Miniconda37\Scripts;%PATH%
pip install tesserocr\dist\tesserocr-2.2.2-cp37-cp37m-win32.whl
conda install Pillow --yes
python tesserocr\tests\test_api.py
